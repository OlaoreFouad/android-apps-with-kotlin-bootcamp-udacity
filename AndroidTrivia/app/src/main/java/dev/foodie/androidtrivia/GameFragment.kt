...
import dev.foodie.androidtrivia.databinding.FragmentGameBinding
        ...
        { view: View ->
            ...
            if (-1 != checkedId) {
                ...
                if (answers[answerIndex] == currentQuestion.answers[0]) {
                    ...
                    view.findNavController().navigate(GameFragmentDirections.actionGameFragmentToGameOverFragment2(questionIndex, numQuestions))
                }
            }
        }
        return binding.root
